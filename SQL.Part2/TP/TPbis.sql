...
/****** Object:  Database [codex]    Script Date: 22/01/2019 09:32:08 ******/
CREATE DATABASE [codex]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'codex', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\codex.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'codex_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\codex_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [codex] SET COMPATIBILITY_LEVEL = 120
GO
...
ALTER DATABASE [codex] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [codex] SET READ_COMMITTED_SNAPSHOT OFF 
GO

ALTER DATABASE [codex] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [codex] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [codex] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
